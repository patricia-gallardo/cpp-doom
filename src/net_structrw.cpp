...
boolean
  NET_ReadQueryData(net_packet_t *packet, net_querydata_t *query)
{
  boolean success;
...
void
  NET_WriteQueryData(net_packet_t *packet, net_querydata_t *query)
{
...
static boolean
  NET_ReadBlob(net_packet_t *packet, uint8_t *buf, size_t len)
{
  unsigned int b;
  int          i;
...
static void
  NET_WriteBlob(net_packet_t *packet, uint8_t *buf, size_t len)
{
  int i;
...
static net_protocol_t
  ParseProtocolName(const char *name)
{
  int i;
