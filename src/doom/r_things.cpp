...
extern void
  P_LineLaser(mobj_t *t1, angle_t angle, fixed_t distance, fixed_t slope);
...
//
void
  R_DrawPSprite(pspdef_t *psp, psprnum_t psprnum) // [crispy] differentiate gun from flash sprites
{
  fixed_t        tx;
  int            x1;
  int            x2;
...
static inline int
  cmp_vissprites(const void *a, const void *b)
{
