  ...
  PIT_VileCheck(mobj_t *thing)
{
  ...
  if (std::abs(thing->x - viletryx) > maxdist
      || std::abs(thing->y - viletryy) > maxdist)
...
static boolean
  CheckBossEnd(mobjtype_t motype)
{
