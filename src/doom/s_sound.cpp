...
static int
  S_GetChannel(mobj_t *origin, sfxinfo_t *sfxinfo)
{
...
void
  S_StartSoundOnce(void *origin_p, int sfx_id)
{
  int                    cnum;
...
void
  S_ChangeMusInfoMusic(int lumpnum, int looping)
{
  musicinfo_t *music;
