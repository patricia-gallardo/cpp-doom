...
extern void
  EnableLoadingDisk();
extern void
  P_SegLengths(boolean contrast_only);
extern void
  R_ExecuteSetViewSize();
extern void
  R_InitLightTables();
extern void
  I_ReInitGraphics(int reinit);
extern void
  ST_createWidgets();
extern void
  HU_Start();
...
void
  M_CrispyToggleAutomapstats(int choice)
{
  choice               = 0;
...
void
  M_CrispyToggleBobfactor(int choice)
{
  choice            = 0;
...
void
  M_CrispyToggleBrightmaps(int choice)
{
  choice             = 0;
...
void
  M_CrispyToggleCenterweapon(int choice)
{
  choice               = 0;
...
void
  M_CrispyToggleColoredblood(int choice)
{
  thinker_t *th;
...
void
  M_CrispyToggleColoredhud(int choice)
{
  choice             = 0;
...
void
  M_CrispyToggleCrosshair(int choice)
{
  choice            = 0;
...
void
  M_CrispyToggleCrosshairHealth(int choice)
{
  choice                  = 0;
...
void
  M_CrispyToggleCrosshairTarget(int choice)
{
  choice                  = 0;
...
void
  M_CrispyToggleCrosshairtype(int choice)
{
  if (!crispy->crosshair)
  {
    return;
...
void
  M_CrispyToggleDemoBar(int choice)
{
  choice          = 0;
...
void
  M_CrispyToggleDemoTimer(int choice)
{
  choice            = 0;
...
void
  M_CrispyToggleDemoTimerDir(int choice)
{
...
void
  M_CrispyToggleExtAutomap(int choice)
{
  choice             = 0;
...
void
  M_CrispyToggleExtsaveg(int choice)
{
  choice           = 0;
...
void
  M_CrispyToggleFlipcorpses(int choice)
{
  if (gameversion == exe_chex)
  {
    return;
...
void
  M_CrispyToggleFreeaim(int choice)
{
...
void
  M_CrispyToggleFreelook(int choice)
{
  choice                      = 0;
...
void
  M_CrispyToggleFullsounds(int choice)
{
  int i;
...
void
  M_CrispyToggleHires(int choice)
{
  choice                      = 0;
...
void
  M_CrispyToggleJumping(int choice)
{
  if (!crispy->singleplayer)
  {
    return;
...
void
  M_CrispyToggleLeveltime(int choice)
{
  choice            = 0;
...
void
  M_CrispyToggleMouseLook(int choice)
{
  choice                      = 0;
...
void
  M_CrispyToggleNeghealth(int choice)
{
  choice            = 0;
...
void
  M_CrispyToggleOverunder(int choice)
{
  if (!crispy->singleplayer)
  {
    return;
...
void
  M_CrispyTogglePitch(int choice)
{
  choice                      = 0;
...
void
  M_CrispyTogglePlayerCoords(int choice)
{
  choice               = 0;
...
void
  M_CrispyToggleRecoil(int choice)
{
  if (!crispy->singleplayer)
  {
    return;
...
void
  M_CrispyToggleSecretmessage(int choice)
{
  choice                = 0;
...
void
  M_CrispyToggleSmoothScaling(int choice)
{
  choice                = 0;
...
static void
  M_CrispyToggleSmoothLightingHook()
{
...
void
  M_CrispyToggleSmoothLighting(int choice)
{
  choice                      = 0;
...
void
  M_CrispyToggleSndChannels(int choice)
{
  choice = 0;
...
void
  M_CrispyToggleSoundfixes(int choice)
{
  choice           = 0;
...
void
  M_CrispyToggleSoundMono(int choice)
{
  choice            = 0;
...
void
  M_CrispyToggleTranslucency(int choice)
{
  choice               = 0;
...
void
  M_CrispyToggleUncapped(int choice)
{
  choice           = 0;
...
void
  M_CrispyToggleVsync(int choice)
{
  choice = 0;
...
void
  M_CrispyToggleWeaponSquat(int choice)
{
  choice              = 0;
...
void
  M_CrispyToggleWidescreen(int choice)
{
  choice                      = 0;
