...
void
  P_LoadSubsectors_DeePBSP(int lump)
{
...
void
  P_LoadNodes_ZDBSP(int lump, boolean compressed)
{
  unsigned int i;
#ifdef HAVE_LIBZ
  byte *output;
