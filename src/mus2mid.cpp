...
static boolean
  WriteTime(unsigned int time, MEMFILE *midioutput)
{
...
static boolean
  WriteEndTrack(MEMFILE *midioutput)
{
...
static boolean
  WritePressKey(byte channel, byte key, byte velocity, MEMFILE *midioutput)
{
...
static boolean
  WriteReleaseKey(byte channel, byte key, MEMFILE *midioutput)
{
...
static boolean
  WritePitchWheel(byte channel, short wheel, MEMFILE *midioutput)
{
...
static boolean
  WriteChangePatch(byte channel, byte patch, MEMFILE *midioutput)
{
...
static boolean
  WriteChangeController_Valued(byte     channel,
                               byte     control,
                               byte     value,
                               MEMFILE *midioutput)
{
...
static boolean
  WriteChangeController_Valueless(byte     channel,
                                  byte     control,
                                  MEMFILE *midioutput)
{
...
static int
  GetMIDIChannel(int mus_channel, MEMFILE *midioutput)
{
...
static boolean
  ReadMusHeader(MEMFILE *file, musheader *header)
{
  boolean result;
...
boolean
  mus2mid(MEMFILE *musinput, MEMFILE *midioutput)
{
