...
int
  M_CheckParmWithArgs(const char *check, int num_args)
{
  int i;
...
static void
  LoadResponseFile(int argv_index, const char *filename)
{
  FILE  *handle;
  int    size;
  char  *infile;
...
static int
  CompareByFileType(const void *a, const void *b)
{
