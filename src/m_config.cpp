...
static default_t *
  SearchCollection(default_collection_t *collection, const char *name)
{
  int i;
...
static void
  SaveDefaultCollection(default_collection_t *collection)
{
  default_t *defaults;
  int        i, v;
  FILE      *f;
...
static int
  ParseIntParameter(const char *strparm)
{
  int parm;
...
static void
  SetVariable(default_t *def, const char *value)
{
  int intparm;
...
static void
  LoadDefaultCollection(default_collection_t *collection)
{
  FILE      *f;
  default_t *def;
  char       defname[80];
...
static default_t *
  GetDefaultForName(const char *name)
{
  default_t *result;
...
void
  M_BindIntVariable(const char *name, int *location)
{
  default_t *variable;
...
void
  M_BindFloatVariable(const char *name, float *location)
{
  default_t *variable;
...
void
  M_BindStringVariable(const char *name, char **location)
{
  default_t *variable;
