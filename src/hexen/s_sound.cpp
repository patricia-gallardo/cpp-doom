...
static boolean
  StartCDTrack(int track, boolean loop)
{
...
boolean
  S_StartCustomCDTrack(int tracknum)
{
  boolean result;
...
void
  S_StartSongName(const char *songLump, boolean loop)
{
  int lumpnum;
  int cdTrack;
  int length;
...
void
  S_StartSoundAtVolume(mobj_t *origin, int sound_id, int volume)
{
  mobj_t    *listener;
  int        dist, vol;
  int        i;
