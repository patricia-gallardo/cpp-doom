...
static void
  DrDeathTally();
static void
  DrNumber(int val, int x, int y, int wrapThresh);
static void
  DrNumberBold(int val, int x, int y, int wrapThresh);
static void
                  DrawHubText();
  ...
  DrDeathTally()
{
  ...
  V_DrawPatch(TALLY_TOP_X, TALLY_TOP_Y, cache_lump_name<patch_t *>("tallytop", PU_CACHE));
  V_DrawPatch(TALLY_LEFT_X, TALLY_LEFT_Y, cache_lump_name<patch_t *>("tallylft", PU_CACHE));
