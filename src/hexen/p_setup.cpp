...
fixed_t
  P_GetMapSky1ScrollDelta(int map)
{
...
fixed_t
  P_GetMapSky2ScrollDelta(int map)
{
...
void
  P_PutMapSongLump(int map, char *lumpName)
{
  ...
  InitMapMusicInfo()
{
  ...
  for (i = 0; i < 99; i++)
  {
    M_StringCopy(MapInfo[i].songLump, DEFAULT_SONG_LUMP, sizeof(MapInfo[i].songLump));
  }
  MapCount = 98;
}
