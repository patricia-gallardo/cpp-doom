...
static void
  CheckOpen();
static void
               OpenScript(const char *name, int type);
...
void
  SC_MustGetStringName(char *name)
{
  SC_MustGetString();
...
int
  SC_MatchString(const char **strings)
{
  int i;
...
int
  SC_MustMatchString(const char **strings)
{
  int i;
...
void
  SC_ScriptError(const char *message)
{
  if (message == NULL)
  {
    message = "Bad syntax.";
