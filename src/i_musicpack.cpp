...
// configuration file.
static const std::array known_filenames = {
  // Doom 1 music files.
  subst_music_t { "b2e05b4e8dff8d76f8f4", "d_inter.{ext}" },
  subst_music_t { "0c0acce45130bab935d2", "d_intro.{ext}" },
  subst_music_t { "fca4086939a68ae4ed84", "d_victor.{ext}"},
  subst_music_t { "5971e5e20554f47ca065", "d_intro.{ext}" },
  subst_music_t { "99767e32769229897f77", "d_e1m1.{ext}"  },
  subst_music_t { "b5e7dfb4efe9e688bf2a", "d_e1m2.{ext}"  },
  subst_music_t { "fda8fa73e4d30a6b961c", "d_e1m3.{ext}"  },
  subst_music_t { "3805f9bf3f1702f7e7f5", "d_e1m4.{ext}"  },
  subst_music_t { "f546ed823b234fe39165", "d_e1m5.{ext}"  },
  subst_music_t { "4450811b5a6748cfd83e", "d_e1m6.{ext}"  },
  subst_music_t { "73edb50d96b0ac03be34", "d_e1m7.{ext}"  },
  subst_music_t { "47d711a6fd32f5047879", "d_e1m8.{ext}"  },
  subst_music_t { "62c631c2fdaa5ecd9a8d", "d_e1m9.{ext}"  },
  subst_music_t { "7702a6449585428e7185", "d_e2m1.{ext}"  },
  subst_music_t { "1cb1810989cbfae2b29b", "d_e2m2.{ext}"  },
  subst_music_t { "7d740f3c881a22945e47", "d_e2m4.{ext}"  },
  subst_music_t { "ae9c3dc2f9aeea002327", "d_e2m6.{ext}"  },
  subst_music_t { "b26aad3caa420e9a2c76", "d_e2m7.{ext}"  },
  subst_music_t { "90f06251a2a90bfaefd4", "d_e2m8.{ext}"  },
  subst_music_t { "b2fb439f23c08c8e2577", "d_e3m1.{ext}"  },
  subst_music_t { "b6c07bb249526b864208", "d_e3m2.{ext}"  },
  subst_music_t { "ce3587ee503ffe707b2d", "d_e3m3.{ext}"  },
  subst_music_t { "d746ea2aa16b3237422c", "d_e3m8.{ext}"  },
  subst_music_t { "3da3b1335560a92912e6", "d_bunny.{ext}" },

 // Duplicates that don't have identical hashes:
  subst_music_t { "4a5badc4f10a7d4ed021", "d_inter.{ext}" }, // E2M3
  subst_music_t { "36b14bf165b3fdd3958e", "d_e1m7.{ext}"  }, // E3M5
  subst_music_t { "e77c3d42f2ea87f04607", "d_e1m6.{ext}"  }, // E3M6
  subst_music_t { "3d85ec9c10b5ea465568", "d_e2m7.{ext}"  }, // E3M7
  subst_music_t { "4d42e2ce1c1ff192500e", "d_e1m9.{ext}"  }, // E3M9

  // These tracks are reused in Alien Vendetta, but are MIDs:
  subst_music_t { "a05e45f67e1b64733fe3", "d_e2m1.{ext}"  }, // MAP02
  subst_music_t { "8024ae1616ddd97ce330", "d_e1m4.{ext}"  }, // MAP03
  subst_music_t { "3af8d79ddba49edaf9eb", "d_victor.{ext}"}, // MAP05
  subst_music_t { "a55352c96c025b6bd08a", "d_inter.{ext}" }, // MAP07
  subst_music_t { "76d1fc25ab7b1b4a58d6", "d_e1m8.{ext}"  }, // MAP11
  subst_music_t { "497777f0863eca7cea87", "d_e1m2.{ext}"  }, // MAP12
  subst_music_t { "0228fd87f8762f112fb6", "d_e2m2.{ext}"  }, // MAP13
  subst_music_t { "db94e8e1d7c02092eab5", "d_e1m6.{ext}"  }, // MAP14
  subst_music_t { "5a8d7a307eebc952795c", "d_e2m7.{ext}"  }, // MAP16
  subst_music_t { "1a36b692bf26d94a72cc", "d_e1m7.{ext}"  }, // MAP23
  subst_music_t { "37c6cefa351b06995152", "d_e1m5.{ext}"  }, // MAP27
  subst_music_t { "36b97b87fe98348d44b6", "d_e2m6.{ext}"  }, // MAP28

  // Doom II music files.
  subst_music_t { "79080e9681a2d7bec3fb", "d_runnin.{ext}"}, // MAP01,15
  subst_music_t { "868b3aae73c7b12e92c0", "d_stalks.{ext}"}, // MAP02,11,17
  subst_music_t { "19237754d2eb85f41d84", "d_countd.{ext}"}, // MAP03,21
  subst_music_t { "00abff3b61b25a6855d2", "d_betwee.{ext}"}, // MAP04
  subst_music_t { "954636c7ee09edf5d98f", "d_doom.{ext}"  }, // MAP05,13
  subst_music_t { "8d32b2b7aa3b806474c1", "d_the_da.{ext}"}, // MAP06,12,24
  subst_music_t { "41efc3c84bb321af2b6b", "d_shawn.{ext}" }, // MAP07,19,29
  // Assuming single D_DDTBLU: http://doomwiki.org/wiki/Doom_II_music#Trivia
  subst_music_t { "51c0872fec9f43259318", "d_ddtblu.{ext}"}, // MAP08
  subst_music_t { "acb7ad85494d18235df8", "d_ddtblu.{ext}"}, // MAP14,22
  subst_music_t { "4b7ceccbf47e78e2fa0b", "d_in_cit.{ext}"}, // MAP09
  subst_music_t { "1d1f4a9edba174584e11", "d_dead.{ext}"  }, // MAP10,16
  subst_music_t { "1736c81aac77f9bffd3d", "d_romero.{ext}"}, // MAP18,27
  subst_music_t { "a55d400570ad255a576b", "d_messag.{ext}"}, // MAP20,26
  subst_music_t { "29d30c3fbd712016f2e5", "d_ampie.{ext}" }, // MAP23
  subst_music_t { "bcfe9786afdcfb704afa", "d_adrian.{ext}"}, // MAP25
  subst_music_t { "e05c10389e71836834ae", "d_tense.{ext}" }, // MAP28
  subst_music_t { "b779022b1d0f0010b8f0", "d_openin.{ext}"}, // MAP30
  subst_music_t { "a9a5f7b0ab3be0f4fc24", "d_evil.{ext}"  }, // MAP31
  subst_music_t { "4503d155aafec0296689", "d_ultima.{ext}"}, // MAP32
  subst_music_t { "56f2363f01df38908c77", "d_dm2ttl.{ext}"},
  subst_music_t { "71e58baf9e9dea4dd24a", "d_dm2int.{ext}"},
  subst_music_t { "e632318629869811f7dc", "d_read_m.{ext}"},
 ...
 // Duplicate filenames: the above filenames are the "canonical" files
  ...
  subst_music_t { "868b3aae73c7b12e92c0", "d_stlks2.{ext}"},
  subst_music_t { "868b3aae73c7b12e92c0", "d_stlks3.{ext}"},
  subst_music_t { "8d32b2b7aa3b806474c1", "d_theda2.{ext}"},
  subst_music_t { "8d32b2b7aa3b806474c1", "d_theda3.{ext}"},
  subst_music_t { "954636c7ee09edf5d98f", "d_doom2.{ext}" },
  subst_music_t { "acb7ad85494d18235df8", "d_ddtbl2.{ext}"},
  subst_music_t { "acb7ad85494d18235df8", "d_ddtbl3.{ext}"},
  subst_music_t { "79080e9681a2d7bec3fb", "d_runni2.{ext}"},
  subst_music_t { "1d1f4a9edba174584e11", "d_dead2.{ext}" },
  subst_music_t { "41efc3c84bb321af2b6b", "d_shawn2.{ext}"},
  subst_music_t { "41efc3c84bb321af2b6b", "d_shawn3.{ext}"},
  subst_music_t { "19237754d2eb85f41d84", "d_count2.{ext}"},
  subst_music_t { "a55d400570ad255a576b", "d_messg2.{ext}"},
  subst_music_t { "1736c81aac77f9bffd3d", "d_romer2.{ext}"},

 // These tracks are reused in Alien Vendetta, but are MIDs:
  subst_music_t { "9433604c098b7b1119a4", "d_in_cit.{ext}"}, // MAP26

  // Heretic tracks.
  subst_music_t { "12818ca0d3c957e7d57e", "mus_titl.{ext}"},
  subst_music_t { "5cb988538ce1b1857349", "mus_intr.{ext}"},
  subst_music_t { "6f126abe35a78b61b930", "mus_cptd.{ext}"},
  subst_music_t { "62557250f0427c067dc9", "mus_e1m1.{ext}"},
  subst_music_t { "1e8d5fd814490b9ae166", "mus_e1m2.{ext}"},
  subst_music_t { "f0f31e8834e85035d434", "mus_e1m3.{ext}"},
  subst_music_t { "054d6997405cc5a32b46", "mus_e1m4.{ext}"},
  subst_music_t { "31950ab062cc1e5ca49d", "mus_e1m5.{ext}"},
  subst_music_t { "7389024fbab0dff47211", "mus_e1m6.{ext}"},
  subst_music_t { "f2aa312dddd0a294a095", "mus_e1m7.{ext}"},
  subst_music_t { "cd6856731d1ae1f3aa4e", "mus_e1m8.{ext}"},
  subst_music_t { "d7fe793f266733d92e61", "mus_e1m9.{ext}"},
  subst_music_t { "933545b48fad8c66f042", "mus_e2m1.{ext}"},
  subst_music_t { "bf88ecd4ae1621222592", "mus_e2m2.{ext}"},
  subst_music_t { "4f619f87a828c2ca4801", "mus_e2m3.{ext}"},
  subst_music_t { "13033a83c49424b2f2ab", "mus_e2m4.{ext}"},
  subst_music_t { "b3851f9351ae411d9de3", "mus_e2m6.{ext}"},
  subst_music_t { "82539791159fbbc02a23", "mus_e2m7.{ext}"},
  subst_music_t { "fd9e53a49cfa62c463a0", "mus_e2m8.{ext}"},
  subst_music_t { "29503959324d2ca67958", "mus_e2m9.{ext}"},
  subst_music_t { "3aa632257c5be375b97b", "mus_e3m2.{ext}"},
  subst_music_t { "69ba0dce7913d53b67a8", "mus_e3m3.{ext}"},

 // These Heretic tracks are reused in Alien Vendetta, but are MIDs:
  subst_music_t { "51344131e8d260753ce7", "mus_e2m3.{ext}"}, // MAP15
  subst_music_t { "78b570b2397570440aff", "mus_e1m1.{ext}"}, // MAP19
  subst_music_t { "ee21ba9fad4de3dfaef0", "mus_e1m4.{ext}"}, // MAP29
  subst_music_t { "d2bb643a60696ccbca03", "mus_e1m9.{ext}"}, // MAP32

  // Hexen tracks:
  subst_music_t { "fbf55fc1ee26bd01266b", "winnowr.{ext}" },
  subst_music_t { "71776e2da2b7ba607d81", "jachr.{ext}"   },
  subst_music_t { "c5c8630608b8132b33cd", "simonr.{ext}"  },
  subst_music_t { "43683b3f55a031de88d4", "wutzitr.{ext}" },
  subst_music_t { "a6062883f29436ef73db", "falconr.{ext}" },
  subst_music_t { "512cb6cc9b558d5f0fef", "levelr.{ext}"  },
  subst_music_t { "d31226ae75fce6a24208", "chartr.{ext}"  },
  subst_music_t { "bf1f1e561bbdba4e699f", "swampr.{ext}"  },
  subst_music_t { "b303193f756ca0e2de0f", "deepr.{ext}"   },
  subst_music_t { "f0635f0386d883b00186", "fubasr.{ext}"  },
  subst_music_t { "18f2a01f83df6e3abedc", "grover.{ext}"  },
  subst_music_t { "b2527eb0522f08b2cf5f", "fortr.{ext}"   },
  subst_music_t { "343addba8ba53a20a160", "foojar.{ext}"  },
  subst_music_t { "c13109045b06b5a63386", "sixater.{ext}" },
  subst_music_t { "693525aaf69eac5429ab", "wobabyr.{ext}" },
  subst_music_t { "8f884223811c2bb8311d", "cryptr.{ext}"  },
  subst_music_t { "de540e6826e62b32c01c", "fantar.{ext}"  },
  subst_music_t { "efdff548df918934f71f", "blechr.{ext}"  },
  subst_music_t { "de91f150f6a127e72e35", "voidr.{ext}"   },
  subst_music_t { "e0497fe27289fe18515b", "chap_1r.{ext}" },
  subst_music_t { "f2ef1abdc3f672a3519a", "chap_2r.{ext}" },
  subst_music_t { "78cd9882f61cc441bef4", "chap_3r.{ext}" },
  subst_music_t { "97b2b575d9d096c1f89f", "chap_4r.{ext}" },
  subst_music_t { "ad0197a0f6c52ac30915", "chippyr.{ext}" },
  subst_music_t { "30506c62e9f0989ffe09", "percr.{ext}"   },
  subst_music_t { "3542803beaa43bf1de1a", "secretr.{ext}" },
  subst_music_t { "81067721f40c611d09fb", "bonesr.{ext}"  },
  subst_music_t { "4822af2e1a2eb7faf660", "octor.{ext}"   },
  subst_music_t { "26bb3cec902ed8008fc2", "rithmr.{ext}"  },
  subst_music_t { "94ab641c7aa93caac77a", "stalkr.{ext}"  },
  subst_music_t { "d0a3f337c54b0703b4d3", "borkr.{ext}"   },
  subst_music_t { "79e7781ec7eb9b9434b5", "crucibr.{ext}" },
  subst_music_t { "c2786e5581a7f8801969", "hexen.{ext}"   },
  subst_music_t { "97fae9a084c0efda5151", "hub.{ext}"     },
  subst_music_t { "c5da52d5c2ec4803ef8f", "hall.{ext}"    },
  subst_music_t { "1e71bc0e2feafb06214e", "orb.{ext}"     },
  subst_music_t { "bc9dcfa6632e847e03af", "chess.{ext}"   },

 // Hexen CD tracks: alternate filenames for a ripped copy of
  // the CD soundtrack.
  subst_music_t { "71776e2da2b7ba607d81", "hexen02.{ext}" }, // level  2 (jachr)
  subst_music_t { "efdff548df918934f71f", "hexen03.{ext}" }, // level 26 (blechr)
  subst_music_t { "c2786e5581a7f8801969", "hexen04.{ext}" }, // (hexen)
  subst_music_t { "1e71bc0e2feafb06214e", "hexen05.{ext}" }, // (orb)
  subst_music_t { "f0635f0386d883b00186", "hexen06.{ext}" }, // level 10 (fubasr)
  subst_music_t { "bc9dcfa6632e847e03af", "hexen07.{ext}" }, // (chess)
  subst_music_t { "8f884223811c2bb8311d", "hexen08.{ext}" }, // level 24 (cryptr)
  subst_music_t { "a6062883f29436ef73db", "hexen09.{ext}" }, // level  5 (falconr)
  subst_music_t { "4822af2e1a2eb7faf660", "hexen10.{ext}" }, // level 36 (octor)
  subst_music_t { "26bb3cec902ed8008fc2", "hexen11.{ext}" }, // level 37 (rithmr)
  subst_music_t { "c13109045b06b5a63386", "hexen12.{ext}" }, // level 22 (sixater)
  subst_music_t { "fbf55fc1ee26bd01266b", "hexen13.{ext}" }, // level  1 (winnowr)
  subst_music_t { "bf1f1e561bbdba4e699f", "hexen14.{ext}" }, // level  8 (swampr)
  subst_music_t { "43683b3f55a031de88d4", "hexen15.{ext}" }, // level  4 (wutzitr)
  subst_music_t { "81067721f40c611d09fb", "hexen16.{ext}" }, // level 35 (bonesr)
  subst_music_t { "e0497fe27289fe18515b", "hexen17.{ext}" }, // level 28 (chap_1r)
  subst_music_t { "97b2b575d9d096c1f89f", "hexen18.{ext}" }, // level 31 (chap_4r)
  subst_music_t { "de540e6826e62b32c01c", "hexen19.{ext}" }, // level 25 (fantar)
  subst_music_t { "343addba8ba53a20a160", "hexen20.{ext}" }, // level 21 (foojar)
  subst_music_t { "512cb6cc9b558d5f0fef", "hexen21.{ext}" }, // level  6 (levelr)
  subst_music_t { "c5c8630608b8132b33cd", "hexen22.{ext}" }, // level  3 (simonr)

  // Strife:
  subst_music_t { "8ac2b2b47707f0fdf8f6", "d_logo.{ext}"  }, // Title
  subst_music_t { "62e1c58054a1f1bc39b2", "d_action.{ext}"}, // 1,15,28
  subst_music_t { "12fa000f3fa1edac5c4f", "d_tavern.{ext}"}, // 2
  subst_music_t { "695e56ab3251792d20e5", "d_danger.{ext}"}, // 3,11
  subst_music_t { "96fe30e8712217b60dd7", "d_fast.{ext}"  }, // 4
  subst_music_t { "61345598a3de04aad508", "d_darker.{ext}"}, // 6,14
  subst_music_t { "52353e9a435b7b1cb268", "d_strike.{ext}"}, // 7,19
  subst_music_t { "061164504907bffc9c22", "d_slide.{ext}" }, // 8,18,22
  subst_music_t { "3dbb4b703ce69aafcdd5", "d_tribal.{ext}"}, // 9
  subst_music_t { "393773688eba050c3548", "d_march.{ext}" }, // 10
  subst_music_t { "3cba3c627de065a667dd", "d_mood.{ext}"  }, // 12
  subst_music_t { "b1f65a333e5c70255784", "d_castle.{ext}"}, // 13
  subst_music_t { "e1455a83a04c9ac4a09f", "d_fight.{ext}" }, // 16,31
  subst_music_t { "17f822b7374b1f069b89", "d_spense.{ext}"}, // 17
  subst_music_t { "e66c5a1a7d05f021f4ae", "d_dark.{ext}"  }, // 20
  subst_music_t { "1c92bd0625026af30dad", "d_tech.{ext}"  }, // 21,27
  subst_music_t { "7ae280713d078de7933a", "d_drone.{ext}" }, // 23,30
  subst_music_t { "4a664afd0d7eae79c97a", "d_panthr.{ext}"}, // 24
  subst_music_t { "4a7d62beeac5601ccf21", "d_sad.{ext}"   }, // 25
  subst_music_t { "e60e109779400f2855d7", "d_instry.{ext}"}, // 26,29
  subst_music_t { "b7d36878faeb291d6df5", "d_happy.{ext}" }, // Better ending
  subst_music_t { "ff4a342c8c5ec51b06c3", "d_end.{ext}"   }, // Worse ending
...
static char * GetFullPath(cstring_view musicdir, cstring_view orig_path) {
  ...
  // parent dir.
  char * result = M_StringJoin(musicdir.c_str(), systemized_path);
...
static void LoadSubstituteConfigs() {
  ...
  for (auto known_filename : known_filenames) {
    AddSubstituteMusic(musicdir, known_filename.hash_prefix, known_filename.filename);
  }
