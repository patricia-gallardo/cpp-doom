...
//
mobj_t *
  P_SpawnSparkPuff(fixed_t x, fixed_t y, fixed_t z)
{
  int t = P_Random();
...
//
mobj_t *
  P_SpawnFacingMissile(mobj_t *source, mobj_t *target, mobjtype_t type)
{
  mobj_t *th;
  angle_t an;
  fixed_t dist;
...
//
mobj_t *
  P_SpawnMortar(mobj_t *source, mobjtype_t type)
{
  mobj_t *th;
  angle_t an;
  fixed_t slope;
