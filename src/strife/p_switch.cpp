...
//
static void
  P_SpawnBrokenGlass(line_t *line)
{
  fixed_t x1;
  fixed_t x2;
  fixed_t y1;
...
//
static void
  P_MoveWall(line_t *line, mobj_t *thing)
{
  vertex_t *v2;
  vertex_t *v1;
  fixed_t   x;
  ...
  P_UseSpecialLine(mobj_t *thing, line_t *line, int side)
{
  ...
  switch (line->special)
  {
    ...
    case 211:
      ...
      if (&players[consoleplayer] == thing->player && thing->player->powers[pw_communicator])
      {
    ...
    case 226:
      ...
      if (EV_DoFloor(line, lowerFloor))
      {
        ...
        P_ChangeSwitchTexture(line, 0);
        DEH_snprintf(usemessage, sizeof(usemessage), "Congratulations! You have completed the training area.");
        thing->player->message = usemessage;
      }
      break;
    ...
    case 233:
      ...
      DEH_snprintf(usemessage, sizeof(usemessage), "Incoming Message from BlackBird...");
      thing->player->message = usemessage;
    ...
    case 234:
      ...
      if (!(thing->player->questflags & QF_QUEST3)) // QUEST3 == Irale
      {
        ...
        DEH_snprintf(usemessage, sizeof(usemessage), "That doesn't seem to work!");
        thing->player->message = usemessage;
      }
