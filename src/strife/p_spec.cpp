  ...
  switch (line->special)
  {
    ...
    case 145:
      ...
      thing->momx = thing->momy = thing->momz = 0;
      {
        ...
        DEH_snprintf(crosslinestr, sizeof(crosslinestr), "Entering%s", DEH_String(mapnames[map - 1]) + 8);
        ...
        if (netgame && deathmatch)
        {
          ...
          {
            DEH_snprintf(crosslinestr, sizeof(crosslinestr), "%d min left", (levelTimeCount / TICRATE) / 60);
            break;
          }
