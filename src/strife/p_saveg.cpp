...
static void
  saveg_read_actionf_t(actionf_t *str)
{
  // actionf_p1 acp1;
...
static void
  saveg_write_actionf_t(actionf_t *str)
{
  // actionf_p1 acp1;
...
static void
  saveg_read_slidedoor_t(slidedoor_t *str)
{
  int sector;
  int line;
...
static void
  saveg_write_slidedoor_t(slidedoor_t *str)
{
  // thinker_t thinker;
  saveg_write_thinker_t(&str->thinker);
...
void
  P_WriteSaveGameHeader(char *description)
{
...
//
void
  P_UnArchivePlayers(boolean userload)
{
  int i;
