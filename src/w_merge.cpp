...
static int
  FindInList(searchlist_t *list, const char *name)
{
  int i;
...
static boolean
  SetupList(searchlist_t *list, searchlist_t *src_list, const char *startname, const char *endname, const char *startname2, const char *endname2)
{
...
static sprite_frame_t *
  FindSpriteFrame(char *name, int frame)
{
...
static boolean
  SpriteLumpNeeded(lumpinfo_t *lump)
{
...
void
  W_MergeFile(const char *filename)
{
  int old_numlumps;
...
static void
  W_NWTAddLumps(searchlist_t *list)
{
  int i;
...
void
  W_NWTMergeFile(const char *filename, int flags)
{
  int old_numlumps;
...
void
  W_NWTDashMerge(const char *filename)
{
  wad_file_t *wad_file;
  int         old_numlumps;
  int         i;
