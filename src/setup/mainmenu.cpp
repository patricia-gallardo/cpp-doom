...
static void SensibleDefaults() {
  g_m_controls_globals->key_up                 = 'w';
  g_m_controls_globals->key_down               = 's';
  g_m_controls_globals->key_strafeleft         = 'a';
  g_m_controls_globals->key_straferight        = 'd';
  g_m_controls_globals->key_jump               = '/';
  g_m_controls_globals->key_lookup             = KEY_PGUP;
  g_m_controls_globals->key_lookdown           = KEY_PGDN;
  g_m_controls_globals->key_lookcenter         = KEY_HOME;
  g_m_controls_globals->key_flyup              = KEY_INS;
  g_m_controls_globals->key_flydown            = KEY_DEL;
  g_m_controls_globals->key_flycenter          = KEY_END;
  ...
  g_m_controls_globals->key_mission            = 'i'; // Strife keys
  g_m_controls_globals->key_invpop             = 'o';
  g_m_controls_globals->key_invkey             = 'p';
  g_m_controls_globals->key_multi_msgplayer[0] = 'g';
  g_m_controls_globals->key_multi_msgplayer[1] = 'h';
  g_m_controls_globals->key_multi_msgplayer[2] = 'j';
  g_m_controls_globals->key_multi_msgplayer[3] = 'k';
  g_m_controls_globals->key_multi_msgplayer[4] = 'v';
  g_m_controls_globals->key_multi_msgplayer[5] = 'b';
  g_m_controls_globals->key_multi_msgplayer[6] = 'n';
  g_m_controls_globals->key_multi_msgplayer[7] = 'm';
  g_m_controls_globals->mousebprevweapon       = 4; // Scroll wheel = weapon cycle
  g_m_controls_globals->mousebnextweapon       = 3;
  g_i_sound_globals->snd_musicdevice           = static_cast<snddevice_t>(3);
  g_m_controls_globals->joybspeed              = 29; // Always run
...
void MainMenu() {
  ...
  TXT_SignalConnect(warp_action, "pressed", WarpMenu, nullptr);
