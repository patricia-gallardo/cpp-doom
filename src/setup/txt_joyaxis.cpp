...
static const char *
  CalibrationLabel(txt_joystick_axis_t *joystick_axis)
{
...
static void
  SetCalibrationLabel(txt_joystick_axis_t *joystick_axis)
{
...
static int
  FindPressedAxisButton(txt_joystick_axis_t *joystick_axis)
{
  int i;
...
static int
  FindUncenteredHat(SDL_Joystick *joystick, int *axis_invert)
{
  int i, hatval;
...
static boolean
  CalibrateAxis(txt_joystick_axis_t *joystick_axis)
{
  int    best_axis;
  int    best_value;
  int    best_invert;
...
static boolean
  SetButtonAxisPositive(txt_joystick_axis_t *joystick_axis)
{
  int button;
...
static void
  IdentifyBadAxes(txt_joystick_axis_t *joystick_axis)
{
  int i, val;
...
static int
  NextCalibrateStage(txt_joystick_axis_t *joystick_axis)
{
  switch (joystick_axis->config_stage)
  {
    case CONFIG_CENTER:
...
static int
  EventCallback(SDL_Event *event, TXT_UNCAST_ARG(joystick_axis))
{
...
static void
  CalibrateWindowClosed(TXT_UNCAST_ARG(widget),
...
void
  TXT_ConfigureJoystickAxis(txt_joystick_axis_t         *joystick_axis,
                            int                          using_button,
...
static void
  TXT_JoystickAxisSizeCalc(TXT_UNCAST_ARG(joystick_axis))
{
  TXT_CAST_ARG(txt_joystick_axis_t, joystick_axis);
...
static void
  TXT_JoystickAxisDrawer(TXT_UNCAST_ARG(joystick_axis))
{
  TXT_CAST_ARG(txt_joystick_axis_t, joystick_axis);
...
static void
  TXT_JoystickAxisDestructor(TXT_UNCAST_ARG(joystick_axis))
{
}

static int
  TXT_JoystickAxisKeyPress(TXT_UNCAST_ARG(joystick_axis), int key)
{
  TXT_CAST_ARG(txt_joystick_axis_t, joystick_axis);
...
static void
  TXT_JoystickAxisMousePress(TXT_UNCAST_ARG(widget),
                             int x,
                             int y,
                             int b)
{
...
txt_joystick_axis_t *
  TXT_NewJoystickAxis(int *axis, int *invert, txt_joystick_axis_direction_t dir)
{
