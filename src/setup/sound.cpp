...
constexpr auto WINDOW_HELP_URL = "https://www.chocolate-doom.org/setup-sound";
...
void ConfigSound(void *, void *) {
  ...
  TXT_AddWidgets(window,
                 ...
                 TXT_If(gamemission == doom,
                        TXT_NewRadioButton("PC speaker effects", &g_i_sound_globals->snd_sfxdevice, SNDDEVICE_PCSPEAKER)),
                 ...
                 TXT_NewRadioButton("OPL (Adlib/Soundblaster)", &g_i_sound_globals->snd_musicdevice, SNDDEVICE_SB),
                 TXT_NewConditional(&g_i_sound_globals->snd_musicdevice, SNDDEVICE_SB, TXT_NewHorizBox(TXT_NewStrut(4, 0), TXT_NewLabel("Chip type: "), OPLTypeSelector(), nullptr)),

                 TXT_NewRadioButton("GUS (emulated)", &g_i_sound_globals->snd_musicdevice, SNDDEVICE_GUS),
                 TXT_NewConditional(&g_i_sound_globals->snd_musicdevice, SNDDEVICE_GUS, TXT_MakeTable(2, TXT_NewStrut(4, 0), TXT_NewLabel("Path to patch files: "), TXT_NewStrut(4, 0), TXT_NewFileSelector(&gus_patch_path, 34, "Select directory containing GUS patches", TXT_DIRECTORY), nullptr)),
                 ...
                 TXT_NewConditional(&g_i_sound_globals->snd_musicdevice, SNDDEVICE_GENMIDI, TXT_MakeTable(2, TXT_NewStrut(4, 0), TXT_NewLabel("Timidity configuration file: "), TXT_NewStrut(4, 0), TXT_NewFileSelector(&timidity_cfg_path, 34, "Select Timidity config file", cfg_extension), nullptr)),
                 nullptr);
}
