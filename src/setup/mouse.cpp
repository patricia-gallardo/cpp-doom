...
static void
  MouseSetCallback(TXT_UNCAST_ARG(widget), TXT_UNCAST_ARG(variable))
{
...
static void
  AddMouseControl(TXT_UNCAST_ARG(table), const char *label, int *var)
{
...
static void
  ConfigExtraButtons(TXT_UNCAST_ARG(widget), TXT_UNCAST_ARG(unused))
{
  txt_window_t *window;
...
void
  ConfigMouse(TXT_UNCAST_ARG(widget), void *user_data)
{
  txt_window_t *window;
