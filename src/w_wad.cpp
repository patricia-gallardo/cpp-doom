...
lumpindex_t
  W_CheckNumForName(const char *name)
{
  lumpindex_t i;
...
//
lumpindex_t
  W_GetNumForName(const char *name)
{
  lumpindex_t i;
...
lumpindex_t
  W_CheckNumForNameFromTo(const char *name, int from, int to)
{
  lumpindex_t i;
...
//
void
  W_ReadLump(lumpindex_t lump, void *dest)
{
  int         c;
  lumpinfo_t *l;
...
[[nodiscard]] void *
  W_CacheLumpNum(lumpindex_t lumpnum, int tag)
{
  void       *result;
  lumpinfo_t *lump;
...
//
[[nodiscard]] void *
  W_CacheLumpName(const char *name, int tag)
{
...
void
  W_ReleaseLumpNum(lumpindex_t lumpnum)
{
  lumpinfo_t *lump;
...
void
  W_ReleaseLumpName(const char *name)
{
...
const char *
  W_WadNameForLump(const lumpinfo_t *lump)
{
  return M_BaseName(lump->wad_file->path);
}

boolean
  W_IsIWADLump(const lumpinfo_t *lump)
{
...
int
  W_LumpDump(const char *lumpname)
{
