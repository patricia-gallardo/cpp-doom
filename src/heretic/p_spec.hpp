...
// when needed
boolean
  P_UseSpecialLine(mobj_t *thing, line_t *line);
void
...
int
  EV_DoDoor(line_t *line, vldoor_e type, fixed_t speed);
void
...
int
  EV_BuildStairs(line_t *line, fixed_t stepDelta);
int
...
boolean
  P_Teleport(mobj_t *thing, fixed_t x, fixed_t y, angle_t angle);
boolean
