...
boolean
  P_UpdateChicken(mobj_t *actor, int tics)
{
  mobj_t    *fog;
  fixed_t    x;
  fixed_t    y;
...
void
  P_DropItem(mobj_t *source, mobjtype_t type, int special, int chance)
{
  mobj_t *mo;
