...
static void
  saveg_read_ticcmd_t(ticcmd_t *str)
{
  // char forwardmove;
...
static void
  saveg_write_ticcmd_t(ticcmd_t *str)
{
  // char forwardmove;
...
static void
  saveg_read_inventory_t(inventory_t *str)
{
  // int type;
...
static void
  saveg_write_inventory_t(inventory_t *str)
{
  // int type;
...
static void
  saveg_read_state_ptr(state_t **state)
{
  int statenum;
...
static void
  saveg_write_state_ptr(state_t *state)
{
  int statenum;
...
static void
  saveg_read_pspdef_t(pspdef_t *str)
{
  // state_t *state;
...
static void
  saveg_write_pspdef_t(pspdef_t *str)
{
  // state_t *state;
...
static void
  saveg_read_player_t(player_t *str)
{
  int i;
...
static void
  saveg_write_player_t(player_t *str)
{
  int i;
...
static void
  saveg_read_mapthing_t(mapthing_t *str)
{
  // short x, y;
  str->x       = SV_ReadWord();
  str->y       = SV_ReadWord();
...
static void
  saveg_write_mapthing_t(mapthing_t *str)
{
  // short x, y;
  SV_WriteWord(str->x);
  SV_WriteWord(str->y);
...
static void
  saveg_read_thinker_t(thinker_t *str)
{
...
static void
  saveg_write_thinker_t(thinker_t *str)
{
  // struct thinker_s *prev, *next;
...
static void
  saveg_read_specialval_t(specialval_t *str)
{
...
static void
  saveg_write_specialval_t(specialval_t *str)
{
  // int i;
  SV_WriteLong(str->i);
}
  ...
  saveg_read_mobj_t(mobj_t *str)
{
  ...
  {
    str->type = static_cast<mobjtype_t>(str->type + 1);
  }
...
static void
  saveg_read_ceiling_t(ceiling_t *str)
{
  int i;
...
static void
  saveg_write_ceiling_t(ceiling_t *str)
{
  // thinker_t thinker;
  saveg_write_thinker_t(&str->thinker);
...
static void
  saveg_read_vldoor_t(vldoor_t *str)
{
  int i;
...
static void
  saveg_write_vldoor_t(vldoor_t *str)
{
  // thinker_t thinker;
  saveg_write_thinker_t(&str->thinker);
...
static void
  saveg_read_floormove_t(floormove_t *str)
{
  int i;
...
static void
  saveg_write_floormove_t(floormove_t *str)
{
  // thinker_t thinker;
  saveg_write_thinker_t(&str->thinker);
...
static void
  saveg_read_lightflash_t(lightflash_t *str)
{
  int i;
...
static void
  saveg_write_lightflash_t(lightflash_t *str)
{
  // thinker_t thinker;
  saveg_write_thinker_t(&str->thinker);
...
static void
  saveg_read_strobe_t(strobe_t *str)
{
  int i;
...
static void
  saveg_write_strobe_t(strobe_t *str)
{
  // thinker_t thinker;
  saveg_write_thinker_t(&str->thinker);
