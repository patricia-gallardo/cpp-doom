...
extern void
  D_ReceiveTic(ticcmd_t *ticcmds, boolean *playeringame);
...
using net_server_recv_t = struct
{
...
using net_server_send_t = struct
{
...
static void
  UpdateClockSync(unsigned int seq,
...
static void
  NET_CL_ExpandFullTiccmd(net_full_ticcmd_t *cmd, unsigned int seq, ticcmd_t *ticcmds)
{
  int i;
...
static void
  NET_CL_SendTics(int start, int end)
{
  net_packet_t *packet;
  int           i;
...
// connection attempt.
static void
  NET_CL_ParseSYN(net_packet_t *packet)
{
...
static void
  NET_CL_ParseReject(net_packet_t *packet)
{
  char *msg;
...
static void
  NET_CL_ParseWaitingData(net_packet_t *packet)
{
...
static void
  NET_CL_ParseLaunch(net_packet_t *packet)
{
...
static void
  NET_CL_ParseGameStart(net_packet_t *packet)
{
...
static void
  NET_CL_SendResendRequest(int start, int end)
{
  net_packet_t *packet;
...
static void
  NET_CL_ParseGameData(net_packet_t *packet)
{
  net_server_recv_t *recvobj;
...
static void
  NET_CL_ParseResendRequest(net_packet_t *packet)
{
...
static void
  NET_CL_ParseConsoleMessage(net_packet_t *packet)
{
  char *msg;
...
static void
  NET_CL_ParsePacket(net_packet_t *packet)
{
...
static void
  NET_CL_SendSYN(net_connect_data_t *data)
{
  net_packet_t *packet;
