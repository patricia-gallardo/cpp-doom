...
static void
  CopyRegion(pixel_t *dest, int dest_pitch, pixel_t *src, int src_pitch, int w, int h)
{
  pixel_t *s, *d;
  int      y;
...
static void
  SaveDiskData(const char *disk_lump, int xoffs, int yoffs)
{
...
void
  V_EnableLoadingDisk(const char *lump_name, int xoffs, int yoffs)
{
