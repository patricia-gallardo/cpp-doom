...
static int
  I_GetPaletteIndex2(byte *palette, int r, int g, int b)
{
...
byte
  V_Colorize(byte *playpal, int cr, byte source, boolean keepgray109)
{
  vect rgb, hsv;
