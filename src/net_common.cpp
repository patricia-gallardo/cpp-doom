...
static void
  NET_Conn_Init(net_connection_t *conn, net_addr_t *addr, net_protocol_t protocol)
{
...
void
  NET_Conn_InitClient(net_connection_t *conn, net_addr_t *addr, net_protocol_t protocol)
{
...
void
  NET_Conn_InitServer(net_connection_t *conn, net_addr_t *addr, net_protocol_t protocol)
{
  NET_Conn_Init(conn, addr, protocol);
...
void
  NET_Conn_SendPacket(net_connection_t *conn, net_packet_t *packet)
{
...
static void
  NET_Conn_ParseDisconnect(net_connection_t *conn, net_packet_t *packet)
{
  net_packet_t *reply;
...
static void
  NET_Conn_ParseDisconnectACK(net_connection_t *conn,
                              net_packet_t     *packet)
{
...
static void
  NET_Conn_ParseReliableACK(net_connection_t *conn, net_packet_t *packet)
{
  unsigned int seq;
...
static boolean
  NET_Conn_ReliablePacket(net_connection_t *conn,
                          net_packet_t     *packet)
{
  unsigned int  seq;
  net_packet_t *reply;
...
boolean
  NET_Conn_Packet(net_connection_t *conn, net_packet_t *packet, unsigned int *packet_type)
{
  conn->keepalive_recv_time = I_GetTimeMS();
...
void
  NET_Conn_Disconnect(net_connection_t *conn)
{
...
void
  NET_Conn_Run(net_connection_t *conn)
{
  net_packet_t *packet;
...
net_packet_t *
  NET_Conn_NewReliable(net_connection_t *conn, int packet_type)
{
  net_packet_t           *packet;
...
unsigned int
  NET_ExpandTicNum(unsigned int relative, unsigned int b)
{
  unsigned int l, h;
  unsigned int result;
...
boolean
  NET_ValidGameSettings(GameMode_t mode, GameMission_t mission, net_gamesettings_t *settings)
{
...
void
  NET_LogPacket(net_packet_t *packet)
{
  int i, bytes;
