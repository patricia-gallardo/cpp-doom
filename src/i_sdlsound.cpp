...
static allocated_sound_t *
  AllocateSound(sfxinfo_t *sfxinfo, size_t len)
{
  allocated_sound_t *snd;
...
static allocated_sound_t *
  GetAllocatedSoundBySfxInfoAndPitch(sfxinfo_t *sfxinfo, int pitch)
{
...
static allocated_sound_t *
  PitchShift(allocated_sound_t *insnd, int pitch)
{
...
static boolean
  ExpandSoundData_SRC(sfxinfo_t *sfxinfo,
                      byte      *data,
                      int        samplerate,
                      int        bits,
                      int        length)
...
static void
  WriteWAV(char *filename, byte *data, uint32_t length, int samplerate)
{
  FILE          *wav;
  unsigned int   i;
  unsigned short s;
...
static int
  I_SDL_StartSound(sfxinfo_t *sfxinfo, int channel, int vol, int sep, int pitch)
{
  allocated_sound_t *snd;
