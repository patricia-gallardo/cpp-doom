...
static inline uint8_t
  get_byte(const uint32_t x, const unsigned n)
{
  return x >> (n << 3);
}
...
static uint32_t
  aes_ror32(uint32_t word, unsigned int shift)
{
 ...
 */
static int
  AES_ExpandKey(aes_context_t *ctx, const uint8_t *in_key, unsigned int key_len)
{
 ...
 */
static int
  AES_SetKey(aes_context_t *ctx, const uint8_t *in_key, unsigned int key_len)
{
  int ret;
...
static void
  AES_Encrypt(aes_context_t *ctx, uint8_t *out, const uint8_t *in)
{
