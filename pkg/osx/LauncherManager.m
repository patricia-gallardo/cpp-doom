...
static NSString *
  GetNextArgument(NSString *commandLine, int *pos, int *arg_pos)
{
  NSRange arg_range;
...
static int
  GetFileInsertIndex(NSString *commandLine, NSString *needle)
{
  NSString *arg;
  int       arg_pos;
  int       pos;
...
static NSString *
  AppendQuotedFilename(NSString *str, NSString *fileName)
{
  int i;
