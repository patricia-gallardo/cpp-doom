...
static Bit16s
  OPL3_EnvelopeCalcExp(Bit32u level)
{
  if (level > 0x1fff)
  {
    level = 0x1fff;
...
static Bit16s
  OPL3_EnvelopeCalcSin0(Bit16u phase, Bit16u envelope)
{
  Bit16u out = 0;
  Bit16u neg = 0;
  phase &= 0x3ff;
...
static Bit16s
  OPL3_EnvelopeCalcSin1(Bit16u phase, Bit16u envelope)
{
  Bit16u out = 0;
  phase &= 0x3ff;
  if (phase & 0x200)
...
static Bit16s
  OPL3_EnvelopeCalcSin2(Bit16u phase, Bit16u envelope)
{
  Bit16u out = 0;
  phase &= 0x3ff;
  if (phase & 0x100)
...
static Bit16s
  OPL3_EnvelopeCalcSin3(Bit16u phase, Bit16u envelope)
{
  Bit16u out = 0;
  phase &= 0x3ff;
  if (phase & 0x100)
...
static Bit16s
  OPL3_EnvelopeCalcSin4(Bit16u phase, Bit16u envelope)
{
  Bit16u out = 0;
  Bit16u neg = 0;
  phase &= 0x3ff;
...
static Bit16s
  OPL3_EnvelopeCalcSin5(Bit16u phase, Bit16u envelope)
{
  Bit16u out = 0;
  phase &= 0x3ff;
  if (phase & 0x200)
...
static Bit16s
  OPL3_EnvelopeCalcSin6(Bit16u phase, Bit16u envelope)
{
  Bit16u neg = 0;
  phase &= 0x3ff;
  if (phase & 0x200)
...
static Bit16s
  OPL3_EnvelopeCalcSin7(Bit16u phase, Bit16u envelope)
{
  Bit16u out = 0;
  Bit16u neg = 0;
  phase &= 0x3ff;
...
static void
  OPL3_EnvelopeKeyOn(opl3_slot *slot, Bit8u type)
{
  slot->key |= type;
}

static void
  OPL3_EnvelopeKeyOff(opl3_slot *slot, Bit8u type)
{
  slot->key &= ~type;
}
...
static void
  OPL3_SlotWrite20(opl3_slot *slot, Bit8u data)
{
  if ((data >> 7) & 0x01)
  {
...
static void
  OPL3_SlotWrite40(opl3_slot *slot, Bit8u data)
{
...
static void
  OPL3_SlotWrite60(opl3_slot *slot, Bit8u data)
{
...
static void
  OPL3_SlotWrite80(opl3_slot *slot, Bit8u data)
{
...
static void
  OPL3_SlotWriteE0(opl3_slot *slot, Bit8u data)
{
...
static void
  OPL3_ChannelUpdateRhythm(opl3_chip *chip, Bit8u data)
{
...
static void
  OPL3_ChannelWriteA0(opl3_channel *channel, Bit8u data)
{
...
static void
  OPL3_ChannelWriteB0(opl3_channel *channel, Bit8u data)
{
  if (channel->chip->newm && channel->chtype == ch_4op2)
  {
    return;
...
static void
  OPL3_ChannelWriteC0(opl3_channel *channel, Bit8u data)
{
...
static void
  OPL3_ChannelSet4Op(opl3_chip *chip, Bit8u data)
{
  Bit8u bit;
  Bit8u chnum;
  for (bit = 0; bit < 6; bit++)
...
void
  OPL3_Generate(opl3_chip *chip, Bit16s *buf)
{
  Bit8u  ii;
  Bit8u  jj;
  Bit16s accm;
...
void
  OPL3_GenerateResampled(opl3_chip *chip, Bit16s *buf)
{
...
void
  OPL3_Reset(opl3_chip *chip, Bit32u samplerate)
{
  Bit8u slotnum;
  Bit8u channum;
...
void
  OPL3_WriteReg(opl3_chip *chip, Bit16u reg, Bit8u v)
{
...
void
  OPL3_WriteRegBuffered(opl3_chip *chip, Bit16u reg, Bit8u v)
{
  Bit64u time1, time2;
...
void
  OPL3_GenerateStream(opl3_chip *chip, Bit16s *sndptr, Bit32u numsamples)
{
  Bit32u i;
