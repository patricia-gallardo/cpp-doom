...
static opl_init_result_t
  InitDriver(opl_driver_t *_driver,
...
static opl_init_result_t
  AutoSelectDriver(unsigned int port_base)
{
  int               i;
...
static void
  DelayCallback(void *delay_data_)
{
...
void
  OPL_AdjustCallbacks(float value)
{
  if (driver != NULL)
  {
