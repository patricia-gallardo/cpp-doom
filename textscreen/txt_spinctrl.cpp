...
static void
  FloatFormatString(float step, char *buf, size_t buf_len)
{
  int precision;
...
static unsigned int
  FloatWidth(float val, float step)
{
...
static unsigned int
  SpinControlWidth(txt_spincontrol_t *spincontrol)
{
...
static void
  TXT_SpinControlSizeCalc(TXT_UNCAST_ARG(spincontrol))
{
...
static void
  SetBuffer(txt_spincontrol_t *spincontrol)
{
  char format[25];
...
static void
  TXT_SpinControlDrawer(TXT_UNCAST_ARG(spincontrol))
{
  TXT_CAST_ARG(txt_spincontrol_t, spincontrol);
  unsigned int       i;
...
static void
  TXT_SpinControlDestructor(TXT_UNCAST_ARG(spincontrol))
{
  TXT_CAST_ARG(txt_spincontrol_t, spincontrol);
...
static void
  AddCharacter(txt_spincontrol_t *spincontrol, int key)
{
...
static void
  Backspace(txt_spincontrol_t *spincontrol)
{
...
static void
  EnforceLimits(txt_spincontrol_t *spincontrol)
{
  switch (spincontrol->type)
  {
    case TXT_SPINCONTROL_INT:
...
static void
  FinishEditing(txt_spincontrol_t *spincontrol)
{
  switch (spincontrol->type)
  {
    case TXT_SPINCONTROL_INT:
...
static int
  TXT_SpinControlKeyPress(TXT_UNCAST_ARG(spincontrol), int key)
{
  TXT_CAST_ARG(txt_spincontrol_t, spincontrol);
...
static void
  TXT_SpinControlMousePress(TXT_UNCAST_ARG(spincontrol),
                            int x,
                            int y,
                            int b)
{
...
static void
  TXT_SpinControlFocused(TXT_UNCAST_ARG(spincontrol), int focused)
{
  TXT_CAST_ARG(txt_spincontrol_t, spincontrol);
