...
static int
  FullWidth(txt_scrollpane_t *scrollpane)
{
...
static int
  FullHeight(txt_scrollpane_t *scrollpane)
{
  if (scrollpane->child != NULL)
  {
...
static int
  NeedsScrollbars(txt_scrollpane_t *scrollpane)
{
  int result;
...
static void
  SanityCheckScrollbars(txt_scrollpane_t *scrollpane)
{
  int scrollbars;
  int max_x, max_y;
...
static void
  TXT_ScrollPaneSizeCalc(TXT_UNCAST_ARG(scrollpane))
{
...
static void
  TXT_ScrollPaneDrawer(TXT_UNCAST_ARG(scrollpane))
{
  TXT_CAST_ARG(txt_scrollpane_t, scrollpane);
  int x1, y1, x2, y2;
  int scrollbars;
...
static void
  TXT_ScrollPaneDestructor(TXT_UNCAST_ARG(scrollpane))
{
  TXT_CAST_ARG(txt_scrollpane_t, scrollpane);
...
static void
  TXT_ScrollPaneFocused(TXT_UNCAST_ARG(scrollpane), int focused)
{
  TXT_CAST_ARG(txt_scrollpane_t, scrollpane);
...
static void
  ShowSelectedWidget(txt_scrollpane_t *scrollpane)
{
...
static int
  PageSelectedWidget(txt_scrollpane_t *scrollpane, int key)
{
...
static int
  InterpretScrollKey(txt_scrollpane_t *scrollpane, int key)
{
  int maxy;
...
static int
  TXT_ScrollPaneKeyPress(TXT_UNCAST_ARG(scrollpane), int key)
{
  TXT_CAST_ARG(txt_scrollpane_t, scrollpane);
  int result;
...
static void
  TXT_ScrollPaneMousePress(TXT_UNCAST_ARG(scrollpane),
                           int x,
                           int y,
                           int b)
{
...
static void
  TXT_ScrollPaneLayout(TXT_UNCAST_ARG(scrollpane))
{
  TXT_CAST_ARG(txt_scrollpane_t, scrollpane);
...
static int
  TXT_ScrollPaneSelectable(TXT_UNCAST_ARG(scrollpane))
{
  TXT_CAST_ARG(txt_scrollpane_t, scrollpane);
