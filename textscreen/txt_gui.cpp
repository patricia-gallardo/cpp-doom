...
void
  TXT_DrawDesktopBackground(const char *title)
{
  int            i;
...
void
  TXT_DrawShadow(int x, int y, int w, int h)
{
  unsigned char *screendata;
  unsigned char *p;
  int            x1, y1;
...
void
  TXT_DrawWindowFrame(const char *title, int x, int y, int w, int h)
{
...
void
  TXT_DrawSeparator(int x, int y, int w)
{
  txt_saved_colors_t colors;
  unsigned char     *data;
  int                x1;
...
void
  TXT_DrawCodePageString(const char *s)
{
  int         x, y;
  int         x1;
  const char *p;
...
void
  TXT_DrawHorizScrollbar(int x, int y, int w, int cursor, int range)
{
  txt_saved_colors_t colors;
  int                x1;
  int                cursor_x;
...
void
  TXT_DrawVertScrollbar(int x, int y, int h, int cursor, int range)
{
  txt_saved_colors_t colors;
  int                y1;
  int                cursor_y;
...
void
  TXT_PushClipArea(int x1, int x2, int y1, int y2)
{
