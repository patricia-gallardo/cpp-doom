...
static void
  TXT_LabelSizeCalc(TXT_UNCAST_ARG(label))
{
...
static void
  TXT_LabelDrawer(TXT_UNCAST_ARG(label))
{
  TXT_CAST_ARG(txt_label_t, label);
  unsigned int x, y;
...
static void
  TXT_LabelDestructor(TXT_UNCAST_ARG(label))
{
  TXT_CAST_ARG(txt_label_t, label);
...
void
  TXT_SetLabel(txt_label_t *label, const char *value)
{
  char        *p;
  unsigned int y;
...
void
  TXT_SetFGColor(txt_label_t *label, txt_color_t color)
{
  label->fgcolor = color;
}

void
  TXT_SetBGColor(txt_label_t *label, txt_color_t color)
{
  label->bgcolor = color;
}
