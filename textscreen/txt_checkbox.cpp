...
static void
  TXT_CheckBoxSizeCalc(TXT_UNCAST_ARG(checkbox))
{
...
static void
  TXT_CheckBoxDrawer(TXT_UNCAST_ARG(checkbox))
{
  TXT_CAST_ARG(txt_checkbox_t, checkbox);
...
static void
  TXT_CheckBoxDestructor(TXT_UNCAST_ARG(checkbox))
{
  TXT_CAST_ARG(txt_checkbox_t, checkbox);
...
static int
  TXT_CheckBoxKeyPress(TXT_UNCAST_ARG(checkbox), int key)
{
  TXT_CAST_ARG(txt_checkbox_t, checkbox);
...
static void
  TXT_CheckBoxMousePress(TXT_UNCAST_ARG(checkbox), int x, int y, int b)
{
  TXT_CAST_ARG(txt_checkbox_t, checkbox);
...
txt_checkbox_t *
  TXT_NewCheckBox(const char *label, int *variable)
{
...
txt_checkbox_t *
  TXT_NewInvertedCheckBox(const char *label, int *variable)
{
