...
static void
  TXT_StrutSizeCalc(TXT_UNCAST_ARG(strut))
{
...
static void
  TXT_StrutDrawer(TXT_UNCAST_ARG(strut))
{
  // Nothing is drawn for a strut.
}

static void
  TXT_StrutDestructor(TXT_UNCAST_ARG(strut))
{
}

static int
  TXT_StrutKeyPress(TXT_UNCAST_ARG(strut), int key)
{
  return 0;
}
...
txt_strut_t *
  TXT_NewStrut(int width, int height)
{
