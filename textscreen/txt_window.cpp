...
void
  TXT_SetWindowAction(txt_window_t     *window,
...
static void
  CalcWindowPosition(txt_window_t *window)
{
...
static void
  LayoutActionArea(txt_window_t *window)
{
  txt_widget_t *widget;
  int           space_available;
...
static void
  DrawActionArea(txt_window_t *window)
{
  int i;
...
static void
  CalcActionAreaSize(txt_window_t *window,
                     unsigned int *w,
                     unsigned int *h)
{
  txt_widget_t *widget;
...
void
  TXT_LayoutWindow(txt_window_t *window)
{
...
static int
  MouseButtonPress(txt_window_t *window, int b)
{
  int           x, y;
  int           i;
  txt_widget_t *widgets;
...
void
  TXT_SetKeyListener(txt_window_t *window, TxtWindowKeyPress key_listener, void *user_data)
{
