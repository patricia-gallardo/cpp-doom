...
static void
  TXT_ButtonSizeCalc(TXT_UNCAST_ARG(button))
{
...
static void
  TXT_ButtonDrawer(TXT_UNCAST_ARG(button))
{
  TXT_CAST_ARG(txt_button_t, button);
  int i;
  int w;
...
static void
  TXT_ButtonDestructor(TXT_UNCAST_ARG(button))
{
  TXT_CAST_ARG(txt_button_t, button);
...
static int
  TXT_ButtonKeyPress(TXT_UNCAST_ARG(button), int key)
{
  TXT_CAST_ARG(txt_button_t, button);
...
static void
  TXT_ButtonMousePress(TXT_UNCAST_ARG(button), int x, int y, int b)
{
  TXT_CAST_ARG(txt_button_t, button);
